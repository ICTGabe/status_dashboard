...
# Configuration - Using Gmail's free SMTP service
app.config['SMTP_SERVER'] = 'smtp.gmail.com'
app.config['SMTP_PORT'] = 587
app.config['SMTP_USERNAME'] = 'user@gmail.com'  # Replace with your Gmail
app.config['SMTP_PASSWORD'] = 'xxxxxx'     # Replace with app password
